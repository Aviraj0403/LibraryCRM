    ...
    return (
        <div className='footer'>
            <div>
                <div className='footer-data'>
                    ...
                    <div className='usefull-links'>
                        <h1>Usefull Links</h1>
                        <a href='#home'>AviRaj</a>
                        <a href='#home'>Ranjan</a>
                        <a href='#home'>Home</a>
                        <a href='#home'>7th sem result</a>
                    </div>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169; 2024 Learning Phase<br /><span>Designed bi AviRaj</span></p>
            </div>
        </div>
    )
}
